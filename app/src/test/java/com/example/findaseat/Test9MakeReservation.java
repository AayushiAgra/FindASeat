 ...
 */
public class Test9MakeReservation {
    @Test
    public void makeReservation() throws IOException {

        // Perry user
        String eIdNumber = "9999999999";
...
//
        ...
        double newSeat1 = (double) avails_indoor_new.get(atimeBlock1);
        double newSeat2 = (double) avails_indoor_new.get(atimeBlock2);
