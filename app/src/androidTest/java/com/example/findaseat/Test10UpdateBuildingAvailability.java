...
public class Test10UpdateBuildingAvailability {
    ...
    @Test
    public void test10UpdateBuildingAvailability() {
        ...
        int initial1 = Integer.valueOf(getText(withId(21)));
        initial1--;
        String expect1 = String.valueOf(initial1);

        ViewInteraction textView = onView(withId(21));
...
//        textView.perform(click());
        ...
        try {
         ...
         marker = mDevice.findObject(new UiSelector().descriptionContains("Taper Hall"));
        try {
            marker.click();
            marker.clickTopLeft();
            Rect rects = marker.getBounds();
        ...
        textView = onView(allOf(withId(21), withText(expect1)));
    }
